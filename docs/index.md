...
1. **[Perception](wiki/01-perception.md)** — Sleep, exercise, information diet. What you allow into your mind.
...
- **[Daily Checklist](practice/daily-checklist.md)** — Morning + day + evening routine

- **[CBT Journal](practice/cbt-journal.md)** — Structured cognitive reappraisal template

- **[Weekly Review](practice/weekly-review.md)** — Sunday reflection and pattern extraction

### Tracking

- **[Progress Tracker](tracker/tracker.md)** — Weekly scoring, monthly summaries, rollout plan

## Quick Start

1. Read the wiki pages (20 min total)
2. Start with the daily checklist — foundations only (sleep, exercise, no-phone, gratitude)
3. Add one practice per week
4. Do the weekly review every Sunday
5. Don't try everything at once — the rollout plan in the tracker has the right sequence
